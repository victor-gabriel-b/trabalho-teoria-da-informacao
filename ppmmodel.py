...
class PpmModel:
	...
	def __init__(self, order, symbollimit, escapesymbol):
		...
		self.order_minus1_freqs = arithmeticcoding.SimpleFrequencyTable(arithmeticcoding.FlatFrequencyTable(symbollimit)) # NOVA MUDANÇA
	...
	def increment_contexts(self, history, symbol):
		...
		#ctx.frequencies.try_remove_escape(self.escape_symbol)
